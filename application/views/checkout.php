...
<body  onload="razorpaySubmit(this);">
    ...
    $description        = $product;
    $txnid              = date("YmdHis");
    $key_id             = "rzp_live_MUKuJouj1bg10p";
    $currency_code      = $currency_code;
    $total              = (int)(1 * 100); // 100 = 1 indian rupees
    $amount             = (int)($grandtotal * 100);
    $merchant_order_id  = "WKW-" . date("YmdHis");
    ...
    <input id="pay-btn" type="submit" onclick="razorpaySubmit(this);" value="Pay Now" class="btn btn-primary" style="opacity:1" />
